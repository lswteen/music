package com.renzo.music.core.exception;


import com.renzo.music.core.response.ApiErrorResponse;
...
public class ApiExceptionHandler {
    @ExceptionHandler(com.renzo.music.core.exception.ApiException.class)
    public ResponseEntity<ApiErrorResponse> handleApiExceptions(com.renzo.music.core.exception.ApiException ex) {
